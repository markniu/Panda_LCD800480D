...
### Support OctoPrint
you can control the octo printing from the lcd, or control the lcd printing from octopi web page.this function only works with PandaPi print mode and version after 2021.3.6
